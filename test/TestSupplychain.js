   ...
   //https://study-hall.udacity.com/rooms/community:nd1309:562321-project-559/community:thread-10546385033-482174?contextType=room
    //describe('Create a Smart Contract', () => { 
        it("Testing smart contract function receiveItem", async() => {
            ...
            var event = await supplyChain.receiveItem(pn, accounts[1], originFactoryName, originFactoryInformation,originFactoryLatitude, originFactoryLongitude, productNotes, {from: originFactoryID, gas: 1000000})
            
            // Get event that is emitted as a result of the smart contract execution
            // https://web3js.readthedocs.io/en/1.0/web3-eth-contract.html#events-allevents
            supplyChain.getPastEvents('Mtl_Received', {
                toBlock: 'latest'
    ...
    it("Testing smart contract function purchaseItem() that allows a distributor to buy widget", async() => {
        ...
        await supplyChain.purchaseItem(pn,{from: originFactoryID,value: web3.utils.toWei('1', 'ether')});
